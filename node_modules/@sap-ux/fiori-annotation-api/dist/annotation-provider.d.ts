 ...
 */
export declare function getXmlServiceArtifacts(odataVersion: ODataVersionType, path: string, metadataFile: TextFile, annotationFiles: TextFile[], fileCache: Map<string, string>): [ServiceArtifacts, V2Annotation[]];
/**
