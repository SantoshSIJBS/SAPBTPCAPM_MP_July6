...
const fiori_annotation_api_2 = require("@sap-ux/fiori-annotation-api");
/**
 *
 */
class ApplicationParser {
            ...
            try {
                ...
                for (const service of services) {
                    ...
                    if (result) {
                        ...
                        const index = (0, service_1.buildServiceIndex)(artifacts, this.index.documents, v2Annotations);
            ...
            for (const service of Object.values(app.services)) {
                if (service.config.type === 'cap') {
                    ...
                    if (result) {
                        ...
                        service.index = (0, service_1.buildServiceIndex)(artifacts, index.documents, v2Annotations);
                    }
                }
            }
        }
        ...
        for (const [key, previousApp] of Object.entries(index.apps)) {
            ...
            if (JSON.stringify(previouslyFoundServices) === JSON.stringify(services)) {
                ...
                for (const service of services) {
                    ...
                    if (result) {
                        const [artifacts, v2Annotations] = result;
                        const serviceIndex = (0, service_1.buildServiceIndex)(artifacts, index.documents, v2Annotations);
        ...
        for (const [dataSourceName, dataSource] of Object.entries(manifestDataSources)) {
            ...
            if (!localUri) {
                ...
                services.push({
                    type: 'cap',
                    name: dataSourceName,
                    path: (0, fiori_annotation_api_2.uniformUrl)(dataSource.uri),
    ...
    parseService(projectRootPath, service) {
        if (service.type === 'cap') {
            const artifacts = fiori_annotation_api_1.CdsAnnotationProvider.getCdsServiceArtifacts(projectRootPath, service.path, this.context.fileCache);
