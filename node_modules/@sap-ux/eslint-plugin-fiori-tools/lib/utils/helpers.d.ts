 ...
 */
export declare function isType(node: unknown, type: string): boolean;
/**
 ...
 */
export declare function isIdentifier(node: unknown): boolean;
/**
 ...
 */
export declare function isMember(node: unknown): boolean;
/**
 ...
 */
export declare function isCall(node: unknown): boolean;
/**
 ...
 */
export declare function isLiteral(node: unknown): boolean;
/**
 ...
 */
export declare function isProperty(node: unknown): boolean;
/**
 ...
 */
export declare function isObject(node: unknown): boolean;
/**
 ...
 */
export declare function isArray(node: unknown): boolean;
/**
 ...
 */
export declare function contains(array: string[], item: string): boolean;
/**
 ...
 */
export declare function startsWith(base: string, sub: string): boolean;
/**
 ...
 */
export declare function containsString(str: string, substring: string): boolean;
/**
 ...
 */
export declare function isWindow(node: unknown): boolean;
/**
 ...
 */
export declare function createIsWindowObject(windowObjects: string[]): (node: unknown) => boolean;
/**
 ...
 */
export declare function createRememberWindow(windowObjects: string[], isWindowObject: (node: unknown) => boolean): (left: unknown, right: unknown) => boolean;
/**
 ...
 */
export declare function createIsDocument(isWindowObject: (node: unknown) => boolean): (node: unknown) => boolean;
/**
 ...
 */
export declare function createIsDocumentObject(documentObjects: string[], isDocument: (node: unknown) => boolean): (node: unknown) => boolean;
/**
 ...
 */
export declare function createRememberDocument(documentObjects: string[], isDocumentObject: (node: unknown) => boolean): (left: unknown, right: unknown) => boolean;
/**
 ...
 */
export declare function buildCalleePath(node: unknown): string;
/**
 ...
 */
export declare function getMemberAsString(node: unknown): string;
/**
 ...
 */
export declare function createIsHistory(isWindowObject: (node: unknown) => boolean): (node: unknown) => boolean;
/**
 ...
 */
export declare function createIsHistoryObject(historyObjects: string[], isHistory: (node: unknown) => boolean): (node: unknown) => boolean;
/**
 ...
 */
export declare function createRememberHistory(historyObjects: string[], isHistoryObject: (node: unknown) => boolean): (left: unknown, right: unknown) => boolean;
/**
 ...
 */
export declare function createIsLocation(isWindowObject: (node: unknown) => boolean): (node: unknown) => boolean;
/**
 ...
 */
export declare function createIsLocationObject(locationObjects: string[], isLocation: (node: unknown) => boolean): (node: unknown) => boolean;
/**
 ...
 */
export declare function createRememberLocation(locationObjects: string[], isLocationObject: (node: unknown) => boolean): (left: unknown, right: unknown) => boolean;
/**
 ...
 */
export declare function getLiteralOrIdentifierName(node: unknown): string;
/**
 ...
 */
export declare function getIdentifierPath(node: unknown): string;
/**
 ...
 */
export declare function resolveIdentifierPath(path: string, variables: Record<string, string[]>): string;
/**
 ...
 * @param variables The variables lookup object
 */
export declare function rememberInterestingVariable(node: unknown, name: string, variables: Record<string, string[]>): void;
/**
 ...
 */
export declare function checkInterestingPath(path: string, interestingPathChecker: (path: string) => boolean): boolean;
/**
 ...
 */
export declare function createVariableDeclaratorProcessor(variables: Record<string, string[]>, interestingPathChecker: (path: string) => boolean): (node: unknown) => void;
/**
 ...
 */
export declare function hasUnderscore(identifier: string): boolean;
/**
 ...
 */
export declare function isForbiddenObviousApi(calleePath: string): string;
/**
 ...
 */
export declare function createStorageRuleHelpers(storageName: string, messageId: string): {
 ...
 */
export declare function createPropertyChecker(propertyGroups: Record<string, string[]>): (node: ASTNode, context: any) => void;
/**
 ...
 */
export declare function createDocumentBasedRuleVisitors(config: {
 ...
 */
export declare function findDeepestExistingPath(startObject: any, pathSegments: string[]): DeepestExistingPathResult | undefined;
/**
 ...
 */
export declare function checkAppTablesConfiguration<DiagnosticType>(page: FeV4PageType | FeV2PageType, parsedApp: ParsedApp, checkConfiguration: (page: any, table: any, parsedApp: ParsedApp, problems: DiagnosticType[], pageSectionLabel?: string) => void): DiagnosticType[];
export {};
