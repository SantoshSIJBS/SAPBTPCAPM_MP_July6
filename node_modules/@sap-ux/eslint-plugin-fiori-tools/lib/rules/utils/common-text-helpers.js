...
exports.resolveTextPropertyPath = void 0;
exports.buildAnnotationEntityTypeMap = buildAnnotationEntityTypeMap;
exports.collectRelevantEntityTypes = collectRelevantEntityTypes;
exports.parseCommonTextAnnotationKey = parseCommonTextAnnotationKey;
const constants_1 = require("../../constants");
var fiori_annotation_api_1 = require("@sap-ux/fiori-annotation-api");
Object.defineProperty(exports, "resolveTextPropertyPath", { enumerable: true, get: function () { return fiori_annotation_api_1.resolveTextPropertyPath; } });
/**
 ...
 */
function buildAnnotationEntityTypeMap(parsedService) {
    const map = new Map();
 ...
 */
function collectRelevantEntityTypes(pages, parsedService) {
    const entityTypePages = new Map();
    const annotationEntityTypeMap = buildAnnotationEntityTypeMap(parsedService);
    const addEntityType = (entityTypeName, pageName) => {
 ...
 */
function parseCommonTextAnnotationKey(annotationKey, relevantEntityTypes) {
    ...
    if (term !== constants_1.COMMON_TEXT) {
        return undefined;
    }
...
//# sourceMappingURL=common-text-helpers.js.map