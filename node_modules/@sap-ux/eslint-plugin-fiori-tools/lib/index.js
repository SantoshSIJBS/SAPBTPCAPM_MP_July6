...
const fioriRules = rules_1.rules;
/**
...
const webappPathRelative = (0, fiori_annotation_api_1.uniformUrl)((0, node_path_1.relative)(process.cwd(), webappPathAbsolute));
const testPathRelative = 'webapp' in pathMappingsAbsolute
    ? node_path_1.posix.join(webappPathRelative, 'test')
    : (0, fiori_annotation_api_1.uniformUrl)((0, node_path_1.relative)(process.cwd(), pathMappingsAbsolute.test ?? (0, node_path_1.join)(process.cwd(), 'webapp/test')));
const localServiceUpperCase = node_path_1.posix.join(webappPathRelative, 'localService');
const localServiceLowerCase = node_path_1.posix.join(webappPathRelative, 'localservice');
...
const prodConfig = [
    {
        ...
        ignores: [
            ...
            `${node_path_1.posix.join(localServiceLowerCase, 'mockserver.js')}`, // But DO ignore mockserver.js specifically
            ...
            `${node_path_1.posix.join(localServiceUpperCase, 'mockserver.js')}`, // But DO ignore mockserver.js specifically
            'backup/**',
            '**/Gruntfile.js',
            '**/changes_preview.js',
            '**/changes_preview.ts',
