...
module.exports = {
  ...
  getCallBackUrl: function (req) {
    ...
    if (req.headers['x-forwarded-path']) {
      ...
      let toCutOut = parsedUrl.path.length;
  ...
  getTenantInfo: function (req) {
    ...
    const tenantid = (req.app && req.app.tenantInfo && req.app.tenantInfo[tenant] && req.app.tenantInfo[tenant].tenantid) || (req.zoneInfo && req.zoneInfo.apptid);
    return {
