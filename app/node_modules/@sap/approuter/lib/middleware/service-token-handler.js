...
module.exports = {
  replaceUserToken: async function (req, session, serviceTag, ignoreDots) {
    ...
    if (session.user && session.user.businessServices && serviceTag && session.user.businessServices[serviceTag] && session.user.businessServices[serviceTag].expireDate > Date.now()) {
