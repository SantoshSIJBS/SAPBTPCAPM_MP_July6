...
class RedisClientDriver {
  constructor(extSessionMgt) {
    ...
    this.connectTimeout = extSessionMgt.connectTimeout || 10000; // Default 10 seconds
    this.commandTimeout = extSessionMgt.commandTimeout || 5000;  // Default 5 seconds
    this.keepAlive = extSessionMgt.keepAlive !== undefined ? extSessionMgt.keepAlive : 30000; // Default 30 seconds
  ...
  initializeClient() {
    ...
    // Timeout configurations
    redisOptions.connectTimeout = this.connectTimeout;
    redisOptions.commandTimeout = this.commandTimeout;
    if (this.keepAlive !== false) {
      redisOptions.keepAlive = this.keepAlive;
    }
