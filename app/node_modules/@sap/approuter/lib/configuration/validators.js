...
const ownSapCloudServiceSchema = require('./schemas/own-sap-cloud-service-schema.json');
let regexErr;
...
module.exports = {
  ...
  validateOwnSapCloudService: function (ownSapCloudService) {
    const validator = new JsonValidator();
    validator.validate(ownSapCloudService, ownSapCloudServiceSchema, 'OWN_SAP_CLOUD_SERVICE');
  },
